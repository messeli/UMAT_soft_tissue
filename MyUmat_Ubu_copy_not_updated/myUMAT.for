...
C       INTEGER NTENS,NDI,NSTATV,NPROPS,MATERIALNUMBER
     ...
     4  JSTEP(4) !|Added from abaq 2016 docum
        ...
        DIMENSION CAUSTR(3,3),XKIRC1(3,3), XA(3), XIF(2)
        ...
        !| CALC STRESS 
        CALL mykstress_calc(DFGRD1,XA,G1,G2,XK,XLOFL,XLSTR,P1,P2,P3,P4,
     ...
     5                      CAUSTR,TIME,PROPS)    !|Cauchy stress SIGMA
        ...
        CALL mykmatrix2vector(CAUSTR, STRESS, nshr)         
        ...
        CALL mykCTM(XKIRC1,DFGRD1,NTENS,PROPS,XA,NPT, !,ITER
     ...
     4              XL1,XL2,XL3,XL4)
      ...
      !| Called Subroutines
      INCLUDE 'mykstress_calc.for' !|Subroutine to calc Cauchy stress
      INCLUDE 'mykpolarDecomp.for' !|Polar decomposition 
      INCLUDE 'mykCTM.for' !|Subroutine to calculate the tangent matrix
      INCLUDE 'myutilities.for' !|Helper subroutines      
